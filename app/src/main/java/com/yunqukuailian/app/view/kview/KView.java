...
//        //中表
    ...
    protected void drawWithFingerClick(Canvas canvas) {
        ...
        if(isShowTitle) {
            super.drawAlphaTopTextBox(res.getString(R.string.open) + Utils.numberFormatString(mOHLCData.get(mShowDataNum - 1 - index + mDataStartIndext).getOpenPrice()) + res.getString(R.string.high) + Utils.numberFormatString(mOHLCData.get(mShowDataNum - 1 - index + mDataStartIndext).getHighPrice()) +
                    res.getString(R.string.low) + Utils.numberFormatString(mOHLCData.get(mShowDataNum - 1 - index + mDataStartIndext).getLowPrice()) + res.getString(R.string.close) + Utils.numberFormatString(mOHLCData.get(mShowDataNum - 1 - index + mDataStartIndext).getClosePrice()) + res.getString(R.string.vol) + mOHLCData.get(mShowDataNum - 1 - index + mDataStartIndext).getVol(), canvas);
    ...
    protected void initAxisY() {
        ...
        for (float i = 0; i < latitudeNum; i++) {
            yValue.add(mMinPrice + i * average);
            String value = Utils.numberFormatString(mMinPrice + i * average);
            TitleY.add(value);
        }
        //处理最大值
        yValue.add((mMaxPrice) / 10 * 10);
        String value = Utils.numberFormatString((mMaxPrice) / 10 * 10);

        TitleY.add(value);
        //设置标题栏右边的刻度
        double value1 = yValue.get(TitleY.size()-1);
        double value2 = yValue.get(TitleY.size() -2);
        TitleY.add(Utils.numberFormatString(value1-value2+value1));
    ...
    private void drawUpperRegion(Canvas canvas) {
        ...
        for (int i = 0; i < mShowDataNum && mDataStartIndext + i < mOHLCData.size(); i++) {
            ...
            //画最大 箭头 todo
            if (mDataStartIndext + i == maxIndex) {
                String maxPrice = Utils.numberFormatString(entity.getHighPrice()) ;
                paint.getTextBounds(maxPrice, 0, 1, rect);
                float w = paint.measureText(maxPrice);
                //左箭头
                if ((i * mCandleWidth + mCandleWidth / 2) > (w + 50)) {
                    if(isArrow) {
                        canvas.drawLine(startX, high - super.getTitleHeight(), startX + DisplayUtil.dip2px(getContext(),10), high - super.getTitleHeight(), paint);
                        canvas.drawLine(startX, high - super.getTitleHeight(), startX + DisplayUtil.dip2px(getContext(),4), high - super.getTitleHeight() - DisplayUtil.dip2px(getContext(),4), paint);
                        canvas.drawLine(startX, high - super.getTitleHeight(), startX + DisplayUtil.dip2px(getContext(),4), high - super.getTitleHeight() + DisplayUtil.dip2px(getContext(),4), paint);
                        canvas.drawText(maxPrice, startX + DisplayUtil.dip2px(getContext(),15), high - super.getTitleHeight() + rect.height() / 2, paint);
                    }
                    ...
                    if(isArrow) {
                        ...
                        canvas.drawLine(startX, high - super.getTitleHeight(), startX - DisplayUtil.dip2px(getContext(),4), high - super.getTitleHeight() + DisplayUtil.dip2px(getContext(),4), paint);
                        canvas.drawLine(startX, high - super.getTitleHeight(), startX - DisplayUtil.dip2px(getContext(),4), high - super.getTitleHeight() - DisplayUtil.dip2px(getContext(),4), paint);
                        canvas.drawText(maxPrice, startX - DisplayUtil.dip2px(getContext(),15) - w, high - super.getTitleHeight() + rect.height() / 2, paint);
                    }else {
            ...
            //最小值
            if (mDataStartIndext + i == minIndex) {
                String minPrice = Utils.numberFormatString(entity.getLowPrice());
                ...
                if ((i * mCandleWidth + mCandleWidth / 2) > (w + 50)) {
                    ...
                    if(isArrow)
                    {
                        canvas.drawLine(startX, low + super.getTitleHeight(), startX + DisplayUtil.dip2px(getContext(),10), low + super.getTitleHeight(), paint);
                        canvas.drawLine(startX, low + super.getTitleHeight(), startX + DisplayUtil.dip2px(getContext(),4), low + super.getTitleHeight() + DisplayUtil.dip2px(getContext(),4), paint);
                        canvas.drawLine(startX, low + super.getTitleHeight(), startX + DisplayUtil.dip2px(getContext(),4), low + super.getTitleHeight() - DisplayUtil.dip2px(getContext(),4), paint);
                        canvas.drawText(minPrice, startX + DisplayUtil.dip2px(getContext(),15), low + super.getTitleHeight() + rect.height() / 2, paint);
                    }else
                    {
                    ...
                    if(isArrow) {
                        ...
                        canvas.drawLine(startX, low + super.getTitleHeight(), startX - DisplayUtil.dip2px(getContext(),4), low + super.getTitleHeight() - DisplayUtil.dip2px(getContext(),4), paint);
                        canvas.drawLine(startX, low + super.getTitleHeight(), startX - DisplayUtil.dip2px(getContext(),4), low + super.getTitleHeight() + DisplayUtil.dip2px(getContext(),4), paint);
                        canvas.drawText(minPrice, startX - DisplayUtil.dip2px(getContext(),15) - w, low + super.getTitleHeight() + rect.height() / 2, paint);
                    }else {
                        float leftr=startX-65-w;
                        float topr=low +rect.height()/2;
                        float rightr=startX-35;
    ...
    protected void drawSticks(Canvas canvas) {
        ...
        if (null != mOHLCData) {
            ...
            for (int i = 0; i < mShowDataNum && mDataStartIndext + i < mOHLCData.size(); i++) {
                ...
                float highY = (float) ((ohlc.getVol() / (mMaxVol)) * mMiddleChartHeight);
